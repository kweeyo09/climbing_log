...
const s = StyleSheet.create({
  ...
  headerTitle:     { fontSize: 32, fontFamily: typography.family.labelBold, fontWeight: typography.weight.bold, color: colors.text, letterSpacing: 0.5 },
  headerSub:       { fontSize: 12, fontFamily: typography.family.label, fontWeight: typography.weight.bold, letterSpacing: 1.5, color: colors.text3, textTransform: 'uppercase', marginTop: 2 },
  ...
  label:           { fontSize: 12, fontFamily: typography.family.label, fontWeight: typography.weight.bold, letterSpacing: 1.5, color: colors.text3, marginBottom: 7 },
  placesBadge:     { fontSize: 11, color: colors.accent, fontFamily: typography.family.label, fontWeight: typography.weight.bold },
  ...
  modalTitle:      { fontSize: 22, fontFamily: typography.family.labelBold, fontWeight: typography.weight.bold, color: colors.text, marginBottom: spacing.sm },
  ...
  calendarTitle:   { fontSize: 24, fontFamily: typography.family.labelBold, fontWeight: typography.weight.bold, color: colors.text },
  calendarSubtitle:{ marginTop: 2, fontSize: 12, fontFamily: typography.family.label, fontWeight: typography.weight.semibold, color: colors.text3, textTransform: 'uppercase', letterSpacing: 1.1 },
  ...
  weekdayText:     { flex: 1, textAlign: 'center', fontSize: 12, fontFamily: typography.family.labelBold, fontWeight: typography.weight.bold, color: colors.text3, letterSpacing: 0.7 },
